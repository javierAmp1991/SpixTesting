...
import {CategoryFilterEntertaiment, DropDownData, CategoryFilter, CategoryPrincipalFilters} from "../dataDemo/data";
...
export default function SearchRestaurant() {
    ...
    const textResultSection: string = "Entretenimiento";
