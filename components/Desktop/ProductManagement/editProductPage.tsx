...
import {LayoutUserAccountProp, ProductManagementeProvider} from "../../../Class/UserAccount/userAccount";
import {ProductManagementeContext} from "../../Providers/UserAccount/ProductManagementProvider";


const titleSection: string = "Editar Producto"
const subtitleSection: string = "Edita tus productos"
const idLabelImage: string = "idLabelPhoto001Id"
const nameText: string = "Nombre"
const namePlaceHolder: string = "Ingrese el nuevo nombre del producto"
const uploadImagetext: string = "Subir Foto"
const descriptionText: string = "Desripcion"
const descriptionPlaceholder: string = "Ingrese la nueva descripcion del producto"
const priceText: string = "Precio"
const pricePlaceholder: string = "Ingrese el nuevo precio del producto"
...
export default function EditProductPage() {
    const productManagementContext: ProductManagementeProvider = useContext(ProductManagementeContext)
