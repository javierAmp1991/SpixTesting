...
import styles from "/styles/Desktop/Events/eventWithBannerSearch.module.css"
import React, {useEffect, useState} from "react";
import Image from "next/image";
import Link from "next/link";
import PrincipalInfoEvent from "../Misc/principalInfoEvent";
import {PrincipalInfoEventProp} from "../Misc/principalInfoEvent";
import ProductViewDesk from "../Misc/productViewDesk";


export default function EventWithBannerVertical({item, darkModeState}) {
                        ...
                        <div className={styles.gridCarrouselProductsEWB}>
                            {
                                item.ListProducts.map((product, index) =>
                                        <ProductViewDesk key={index} isDisplayOffer={false} item={product} size={110}/>
