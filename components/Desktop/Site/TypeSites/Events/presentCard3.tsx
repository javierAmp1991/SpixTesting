import style from "/styles/Desktop/Site/TypeSite/Events/presentCard3.module.css";
...
export default function PresentCard3() {
    ...
    return (
        <div className={style.mainDiv}>
                ...
                <div className={style.gridImages}>
                    {
                        info.Images.map((item, index) =>
                            index >= 2 &&
                            <div className={`${style.sizeImage123}`}>
            ...
            {/*  <div className={style.gridImages}>
                {
                    info.Images.map((item, index) =>
                        <div style={{marginTop: `${index+1}0px`}} className={`${style.sizeImage123}`}>
                            <Image layout={"fill"} src={item}/>
                        </div>)
                }
            </div>*/}
