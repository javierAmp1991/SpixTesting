...
import style from "/styles/Desktop/Site/TypeSite/Bussines/Default/productSection.module.css"

export default function ProductSectionDefault({sectionProducts}: { sectionProducts: SectionProductItem }) {
    return (
