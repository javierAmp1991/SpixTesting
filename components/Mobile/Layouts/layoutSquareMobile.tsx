import style from "/styles/Mobile/Layouts/layoutSquare.module.css"
...
export default function LayoutSquareMobile({children, LayoutProp}: { children: JSX.Element, LayoutProp: LayoutSquareProp}) {
