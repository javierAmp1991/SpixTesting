import style from "/styles/Mobile/Site/TypeSite/Bussines/Misc/layoutTitle.module.css";
...
const defaultValues = {
    ...
    PaddingLeft: 0,
    PaddingRight: 0,
    PaddingUnderHeader: 24
}

export default function LayoutTitleCustomMobile({children, item}: { children: JSX.Element, item: LayoutTitleLinkProps }) {
