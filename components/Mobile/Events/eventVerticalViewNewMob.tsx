...
import styles from "/styles/Mobile/Events/eventVerticalViewNewMob.module.css"
...
import PrincipalInfoEvent, {PrincipalInfoEventProp} from "../../Desktop/Misc/principalInfoEvent";
import DateInfoEvent, {DateInfoProp} from "../../Desktop/Misc/dateInfoEvent";
import PriceIncludeInfoEvent, {PriceIncludeInfoProp} from "../../Desktop/Misc/priceIncludeInfoEvent";
const totalResaleText = "Total reventas: "

export default function EventVerticalViewNewMob({item, darkModeState}: { item: BaseEventCard, darkModeState: boolean }) {
