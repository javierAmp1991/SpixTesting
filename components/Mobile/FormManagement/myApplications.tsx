import style from "/styles/Mobile/FormManagement/myApplications.module.css"
...
import InputSelectCustom, {OptionSelectCustom, SelectCustomProps} from "../../Desktop/Misc/inputSelectCustom";

const title: string = "Aplicaciones"

export default function MyApplicationsMobile() {
