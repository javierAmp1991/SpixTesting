...
export default function SocialBar() {
    ...
    return (
        <div className={style.gridSocialBar}>
            <button onClick={()=> handleClick(!isLikeHeart)} className={`${utilities.gridMaxContent2} ${style.gridIcon}`}>
            ...
            <button onClick={() => handleBell(!isLikeBell)} className={`${utilities.gridMaxContent2} ${style.gridIcon}`}>
