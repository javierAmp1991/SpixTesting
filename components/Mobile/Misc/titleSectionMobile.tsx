...
export default function TitleSectionMobile({children, darkModeState, titleLink, paddingTitle, paddingLeft}) {
    ...
    function getCssStyles() {
        return {
            ...
            padding: paddingTitle != null ? {paddingBottom: paddingTitle, paddingLeft: paddingLeft} : {}
        }
    }
}