...
import CustomInputLabel, {InputLabelProps} from "../../Desktop/Misc/customInputLabel";
...
export default function PopUpCreateEditProductMobile({handleChange, closePopUp, item}:
